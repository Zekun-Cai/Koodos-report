...
为了应对这些场景中的模型泛化，我们提出了“**连续时域泛化**”（Continuous Temporal Domain Generalization, CTDG）任务，其中观测和未观测的领域均分布于连续时间轴上随机的时间点。**CTDG 的核心在于如何表征不规律时间分布域的连续动态，使得模型能够在任意时间点实现稳定、适应性的调整，完成泛化预测**。
...
更具体的，与TDG任务相比，CTDG的挑战性来自以下几个尚未被充分探索的关键障碍：
